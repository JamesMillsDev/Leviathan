...
namespace Leviathan.Input
{
	...
	{
		None = -1,
		North = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_RIGHT_FACE_UP,
		East = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_RIGHT_FACE_RIGHT,
		South = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_RIGHT_FACE_DOWN,
		West = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_RIGHT_FACE_LEFT,
		DPadUp = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_LEFT_FACE_UP,
		DPadRight = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_LEFT_FACE_RIGHT,
		DPadDown = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_LEFT_FACE_DOWN,
		DPadLeft = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_LEFT_FACE_LEFT,
		RightStick = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_RIGHT_THUMB,
		LeftStick = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_LEFT_THUMB,
		RightBumper = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_RIGHT_TRIGGER_1,
		LeftBumper = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_LEFT_TRIGGER_1,
		RightTrigger = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_RIGHT_TRIGGER_2,
		LeftTrigger = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_LEFT_TRIGGER_2,
		Select = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_MIDDLE_LEFT,
		Pause = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_MIDDLE_RIGHT,
		Center = Raylib_CsLo.GamepadButton.GAMEPAD_BUTTON_MIDDLE
	}
	...
	{
		None = -1,
		Left = Raylib_CsLo.MouseButton.MOUSE_BUTTON_LEFT,
		Right = Raylib_CsLo.MouseButton.MOUSE_BUTTON_RIGHT,
		Middle = Raylib_CsLo.MouseButton.MOUSE_BUTTON_MIDDLE,
		Side = Raylib_CsLo.MouseButton.MOUSE_BUTTON_SIDE,
		Extra = Raylib_CsLo.MouseButton.MOUSE_BUTTON_EXTRA,
		Forward = Raylib_CsLo.MouseButton.MOUSE_BUTTON_FORWARD,
		Back = Raylib_CsLo.MouseButton.MOUSE_BUTTON_BACK
	}
